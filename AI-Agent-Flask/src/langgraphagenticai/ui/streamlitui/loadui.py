...
class LoadStreamlitUI:
    def __init__(self):
        self.config = (
            Config()
        )  # Config class is imported from the config file(uiconfigfile.py)
        self.user_controls = {}  # This is a dictionary to store the user controls

    def load_streamlit_ui(self):
        page_title = self.config.get_page_title()
        st.set_page_config(
            page_title=page_title, layout="wide"
        )  # This is the title of the streamlit app
        st.header(
            page_title
        )  # This is the header of the streamlit app from the config file

        with st.sidebar:  # This is the sidebar of the streamlit app
            # Get options from config
            llm_options = (
                self.config.get_llm_options()
            )  # This is a list of LLM options from the config file
            usecase_options = (
                self.config.get_usecase_options()
            )  # This is a list of Usecase options from the config file
            ...
            ):  # This is the Groq model selection
                # Model selection
                model_options = (
                    self.config.get_groq_model_options()
                )  # This is a list of Groq model options from the config file
            ...
            if (
                self.user_controls["selected_llm"] == "OpenAI"
            ):  # This is the OpenAI model selection
                # Model selection
                model_options = (
                    self.config.get_openai_model_options()
                )  # This is a list of OpenAI model options from the config file
            ...
            ):  # This is the Gemini model selection
                # Model selection
                model_options = (
                    self.config.get_gemini_model_options()
                )  # This is a list of Gemini model options from the config file
            ...
            if (
                self.user_controls["selected_llm"] == "Ollama"
            ):  # This is the Ollama model selection
                # Model selection
                model_options = (
                    self.config.get_ollama_model_options()
                )  # This is a list of Ollama model options from the config file
            ...
            )  # This is the Usecase selection from the config file
